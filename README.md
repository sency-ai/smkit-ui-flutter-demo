...
This demo is aligned with `flutter_smkit_ui` `1.5.2`.

Native versions used by the Flutter SDK:
- iOS: `SMKitUI` / `SMKit` `2.0.0`
- Android: `com.sency.smkitui:smkitui` / `com.sency.smkit:smkit` `1.6.8`
